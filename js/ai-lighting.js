...
// Глобальная переменная - проверяем, не объявлена ли уже
if (typeof window.selectedMainLightType === 'undefined') {
    window.selectedMainLightType = 'GX53';
}
let selectedMainLightType = window.selectedMainLightType;
